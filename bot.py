...
SCENARIOS = {
    'Vlasta': {
        ...
        'prompt': (
            ...
            "Помни: твоя цель не в том, чтобы она \"поняла себя\", а в том, чтобы она получила работающие инструменты и начала применять их на практике. Результат — измен        ),оты (без прямых продаж).\n"
